jQuery(document).ready(function( $ ){
	...
	// Add and remove table rows for repeater
	...
	$(document.body).on('click', '.image-button', function(e){
	// Prevent the default action from occuring.
	e.preventDefault();
	var mybutton = $(this);
	var row = mybutton.closest('tr');
...
// BUGGY!
			...
			row.children('td').find( 'input' ).val(media_attachment.url);
